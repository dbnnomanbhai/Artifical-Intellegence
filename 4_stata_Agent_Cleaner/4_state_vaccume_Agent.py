...
# The code has been Modified By "Najmul Uddin" <..................Noman bhai.............>
class Object:
...
class vaccumEnvironment():
    ...
    def __init__(self):
        ...
        self.status = {loc_A: random.choice(['Clean', 'Dirty']), loc_B: random.choice(['Clean', 'Dirty']),
                       ...
                       loc_C: random.choice(['Clean', 'Dirty']), loc_D: random.choice(['Clean', 'Dirty'])
...
def tableDrivenVaccumAgent():
    table = {
        ...
        (('A', 'Clean'), ('B', 'Clean'), ('C', 'Clean'), ('D', 'Clean')): 'do nothing',

        (('A', 'Clean'), ('B', 'Clean'), ('D', 'Clean'), ('C', 'Clean')): 'do nothing',

        (('B', 'Clean'), ('A', 'Clean'), ('D', 'Clean'), ('C', 'Clean')): 'do nothing',

        (('B', 'Clean'), ('D', 'Clean'), ('A', 'Clean'), ('C', 'Clean')): 'do nothing',

        (('A', 'Clean'), ('C', 'Clean'), ('B', 'Clean'), ('D', 'Clean')): 'do nothing',

        (('A', 'Clean'), ('D', 'Clean'), ('C', 'Clean'), ('B', 'Clean')): 'do nothing',

        (('B', 'Clean'), ('A', 'Clean'), ('C', 'Clean'), ('D', 'Clean')): 'do nothing',

        (('B', 'Clean'), ('D', 'Clean'), ('C', 'Clean'), ('A', 'Clean')): 'do nothing',
...
class modelBasedVaccumAgent(Agent):
    ...
    def __init__(self):
        ...
        def program(percept):
            ...
            if model[loc_A] == model[loc_B] == model[loc_C] == model[loc_D]:
